...
return [
    ...
    'min' => [
        ...
        'string' => 'Le champ doit être au moins de :min caractères.',
    ],
    ...
    'password' => [
        ...
        'mixed' => 'Le champ doit contenir au moins une lettre majuscule et une minuscule.',
        'numbers' => 'Le champ doit contenir au moins un chiffre.',
        'symbols' => 'Le champ doit contenir au moins un symbole.',
        'uncompromised' => 'Le mot de passe donné a été découvert dans une fuite de données. Veuillez en choisir un autre.',
    ],
    ...
    */
    ...
    | Cela aide simplement à rendre notre message plus expressif.
    |
    */
